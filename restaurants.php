        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" height="35" width="100" src="images/food-picky-logo.png" alt=""> </a>
													 ...
													 echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															...
															<div class="entry-dscr">
																...
																<ul class="list-inline">
																	<li class="list-inline-item"><i class="fa fa-check"></i> Min Rs 700</li>
                ...
                <div class="container">
                    ...
                    <div class="row top-footer">
                        <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                            <a href="#"> <img src="images/food-picky-logo.png" width="200" height="100" alt="Footer logo" > </a> <span>Order Delivery &amp; Take-Out </span> </div>
